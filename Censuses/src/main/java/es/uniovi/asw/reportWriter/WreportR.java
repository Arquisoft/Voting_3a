...
/**
 * Clase que registra las incidencias en un fichero de LOG para que éstas puedan
 * ser reportadas
 * 
 * Patrón Singleton
 * 
...
public class WreportR implements WriteReport {
	...
	public void writeReport(String fichero, Exception e) {
		try (PrintWriter out = new PrintWriter(
				new BufferedWriter(new FileWriter("src/main/resources/log.txt", true)))) {
			String line = "[" + wReport.getFormat().format(wReport.getDate()) + "]" + " FILE: " + fichero
